...
const HeroSection = () => {
  return (
    <div className="relative h-[500px] bg-cover bg-center flex flex-col justify-center items-center text-white text-center px-6" style={{ backgroundImage: 'url(path/to/background-image.jpg)' }}>
      <div className="absolute inset-0 bg-black bg-opacity-50"></div>
      <div className="relative z-10 max-w-2xl">
        <h1 className="text-4xl font-bold mb-4">Transforming Ideas into Green Startups</h1>

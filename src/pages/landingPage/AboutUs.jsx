    ...
    <div className="container mx-auto my-10 px-4">
      ...
      <div className="flex flex-col md:flex-row items-center mb-10">
        <div className="md:w-1/2">
          ...
          <div className="mt-4">
            <a href="/more-info" className="text-green-600 font-semibold hover:underline">
              Read More
            </a>
          </div>
        </div>
      ...
      <div className="flex flex-col md:flex-row mt-5">
        <div className="md:w-1/2 mb-5 md:mb-0">
          <h2 className="text-2xl font-semibold mb-3 border-b-2 border-green-600 pb-2">Our Vision</h2>
        ...
        <div className="md:w-1/2">
          <h2 className="text-2xl font-semibold mb-3 border-b-2 border-green-600 pb-2">Our Mission</h2>
          <p className="text-gray-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <div key={index} className="p-5 bg-white rounded-3xl shadow-sm text-center">
            <img src={value.icon} alt={value.title} className="w-16 h-16 mb-2 mx-auto" />

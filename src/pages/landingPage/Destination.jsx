...
const DifferentDestinations = () => {
  return (
    <div className="my-12">
      <h2 className="text-center text-3xl font-bold mb-4">Green Impact Areas</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <motion.button
            className="absolute top-2 left-2 bg-blue-500 text-white text-xs font-bold py-1 px-2 rounded"
            animate={{
        ...
        >
          ...
          <div className="p-6">
            <h5 className="text-lg font-semibold mb-2">Sustainable Innovators</h5>
            <p className="text-gray-600 mb-4 text-sm">
